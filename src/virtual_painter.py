...
folderPath = Path(__file__).resolve().parent.parent / "assets" / "header"
myList = sorted(f for f in os.listdir(folderPath) if f.lower().endswith('.png'))
# list that have all the images matrices
overlayList = []
for imgPath in myList:
    image = cv.imread(str(folderPath / imgPath))
